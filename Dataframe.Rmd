...
Top left:
This graph plots the relationship between count of negative PANAS words on the y-axis  and the countries’ depressive disorder prevalence (percentage of total population) on the x-axis. As we see an increase in negative PANAS word counts, an increase in depressive disorder prevalence is also observed. Overall, this plot indicates a greater amount of negative PANAS words may be related to an increased prevalence of depressive disorder. 
...
for(i in 0:999){
  ...
  mdd_control <- append(mdd_control, result[0])
}
