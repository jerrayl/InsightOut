...
ggplot(da, aes(x=percentage_mdd, y=mean_positive)) +
  geom_point() +
  facet_wrap(~cluster, scales = "free") +
  geom_smooth(method=lm) +
  labs(x="major depressive disorder prevalence/%", y="mean positive")

ggplot(da, aes(x=percentage_mdd, y=mean_negative)) +
  geom_point() +
  facet_wrap(~cluster, scales = "free") +
  geom_smooth(method=lm) +
  labs(x="major depressive disorder prevalence/%", y="mean negative")


ggplot(da, aes(x=percentage_anxiety, y=mean_positive)) +
  geom_point() +
  facet_wrap(~cluster, scales = "free") +
  geom_smooth(method=lm) +
  labs(x="anxiety disorder prevalence/%", y="counts per 1000, ratio")
...
ggplot(da, aes(x=percentage_anxiety, y=mean_negative)) +
  geom_point() +
  facet_wrap(~cluster, scales = "free") +
  geom_smooth(method=lm) +
  labs(x="anxiety disorder prevalence/%", y="counts per 1000, ratio")
...
```{r calculatecontrol, include=FALSE}
